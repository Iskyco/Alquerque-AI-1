...
class Move {
    ...
    static Move move(Move move0, Move move1) {
        ...
        if (move0.jumpTail() == null) {
            ...
            return Move.move(move0.col0(), move0.row0(),
                    ...
                    Move.move(move0.jumpTail(), move1));
        }
     ...
     */
    boolean isLeftMove() {
        return _row0 == _row1 && (_col0 - _col1 == 1);
    ...
    private void toString(Formatter out) {
        Move nextjump = _nextJump;
        out.format("%c%c-%c%c", _col0, _row0, _col1, _row1);
        while (nextjump != null) {
            out.format("-%c%c", nextjump.col1(), nextjump.row1());
            nextjump = nextjump._nextJump;
        }
    }
